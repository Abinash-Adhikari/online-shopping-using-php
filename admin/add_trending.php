                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody class="tbody text-center">
                                            <?php
                                                ...
                                                $showProduct_sql="SELECT * FROM trending where `seller_name`='$sessionName' order by 'trending' desc";
                                                //$showProduct_sql="SELECT * FROM trending order by 'trending' desc";
                                            ...
                                            <tr>
                                                ...
                                                <td scope="col"><div><button class="btn btn-delete"><a href="deleteProduct.php?table=<?php echo $row['name']?>&product=<?php echo $row1['product_name'] ?>"><i class="fas fa-trash"></i></a></button></div></td>
                                             </tr>
                                            <?php 
                                                $i++;
                                                }
