<?php
    ...
    if(isset( $_SESSION['fullname']) && ($_SESSION['fullname']!=""))
    {
        if(isset($_POST['createCategories'])){
            ...
            $sql_check = "SELECT * FROM categories WHERE  name = '$catName'";
            ...
            if(mysqli_num_rows($check_result) == 0){
                ...
                if($result== TRUE){
                    ...
                    if( mysqli_query($conn,$sql2)){
                        header("location: manage_categories.php?table=categoriestablinserted&tablecreated");
                    }else{
                    ...
                    header("location: manage_categories.php?table=1");
            }
