        ...
        <!--Manage Categories-->
            <div class="manage-categories col-9 m-2">
                <div class="top-container col-7 m-auto text-center bg-white b-color">
                    ...
                    <form action="createCategoriesSecond.php" method="POST">
                            ...
                            <table class="table table-striped allCategories">
                                ...
                                if(isset($_GET['type']) && $_GET['type'] != '' ){
                                        ...
                                        if($type == 'status'){
                                            ...
                                            $update_status = "update categories2 set status='$status' where Name='$name'";
                                ...
                                <tbody class="tbody">
                                    <tr>
                                        ...
                                        <td scope="col">
                                            <a href="deleteCategoriesSecond.php?Name=<?php echo $row['name'] ?>"><button class="btn btn-delete"><i class="fas fa-trash m-2"></i>Delete</button></a>
                                        </td>
                                    </tr>
                                </tbody>
                                <?php 
